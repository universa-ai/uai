...
console.log(buffer.toString()); // Hello World!\n`}
      ...
      <List>
        <Item>`Buffer`, `Uint8Array`, `Uint16Array`, `Uint32Array`, `Int8Array`, `Int16Array`, `Int32Array`, `Float32Array`, `Float64Array`, `ArrayBuffer`, `SharedArrayBuffer` (writes to the underlying buffer)</Item>
        <Item>`Bun.file(path)`, `Bun.file(fd)` (writes to the file)</Item>
      </List>
    </SubSection>
    <SubSection title="Example: Redirect input from JavaScript objects (`<`)">
      <Code language="js">
        {`import { $ } from "bun";
...
console.log(result); // hello i am a response body`}
      ...
      <List>
        <Item>`Buffer`, `Uint8Array`, `Uint16Array`, `Uint32Array`, `Int8Array`, `Int16Array`, `Int32Array`, `Float32Array`, `Float64Array`, `ArrayBuffer`, `SharedArrayBuffer` (reads from the underlying buffer)</Item>
        <Item>`Bun.file(path)`, `Bun.file(fd)` (reads from the file)</Item>
        <Item>`Response` (reads from the body)</Item>
      </List>
    </SubSection>
    <SubSection title="Example: Redirect stdin -> file">
      <Code language="js">
        {`import { $ } from "bun";
...
await $`cat < myfile.txt`;`}
    ...
    <SubSection title="Example: Redirect stdout -> file">
      <Code language="js">
        {`import { $ } from "bun";
...
await $`echo bun! > greeting.txt`;`}
    ...
    <SubSection title="Example: Redirect stderr -> file">
      <Code language="js">
        {`import { $ } from "bun";
...
await $`bun run index.ts 2> errors.txt`;`}
    ...
    <SubSection title="Example: Redirect stderr -> stdout">
      <Code language="js">
        {`import { $ } from "bun";
...
await $`bun run ./index.ts 2>&1`;`}
    ...
    <SubSection title="Example: Redirect stdout -> stderr">
      <Code language="js">
        {`import { $ } from "bun";
...
await $`FOO=${foo} bun -e 'console.log(process.env.FOO)'`; // bar123; rm -rf /tmp\n`}
    ...
    <SubSection title="Changing the environment variables">
      <Paragraph>
...
await $`echo $FOO`.env(undefined); // ""`}
    ...
    <SubSection title="Changing the working directory">
      <Paragraph>
...
console.log(result); // Hello World!\n`}
    ...
    <SubSection title="Reading output as JSON">
      <Paragraph>
...
console.log(result); // { foo: "bar" }`}
    ...
    <SubSection title="Reading output line-by-line">
      <Paragraph>
...
for await (let line of $`cat list.txt | grep ${search}`.lines()) {
  console.log(line);
    ...
    <SubSection title="Reading output as a Blob">
      <Paragraph>
...
// => ["echo 1", "echo 2", "echo 3"]`}
    ...
    <SubSection title="`$.escape` (escape strings)">
      <Paragraph>
