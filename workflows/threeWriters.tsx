...
async function threeWriters(userMessage, outputPath) {
  const promptEngineer = (
    <fragment>
      ...
      <system>
        <instruction>
          As a prompt engineer, write a three set of writing rules tailored for
          three independent content writers, instructing them to complete the
          task given by user accordingly to their each style.
        </instruction>
        <responseFormat>
          ...
          <finalResponse>
            <variations>
              <conservativeWriter>
                he should write in more technical and precise language, focused
                on clarity and avoidance of mistakes
              </conservativeWriter>
              <creativeWriter>
                he should express the idea in more unpredictable manner, using
                emoji and analogies, focused more to captivate reader attention,
                and less afraid to make mistakes
              </creativeWriter>
              <easyWriter>
                he should write using very simple words and minimal structure of
                each sentence, avoid applying non-necessary epitetes, to ensure
                every non-native speaker can understand the text as well
              </easyWriter>
            </variations>
          </finalResponse>
        </responseFormat>
