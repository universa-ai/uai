...
export default async function (originalQuery, targetPath) {
  ...
  const generatedTasks = await prompt(
    <>
      ...
      <system>
        <instruction>
          You are prompt engineer, based on user query, provide a several
          prompts for different agents attempting to answer user query. Provide
          detailed instructions on answering that particular questions,
          describing the level of details, tone and etc accordingly to each
          agent.
        </instruction>
        <responseFormat>
          ...
          <taskResponse>
            <variations>
              <kidAgent>
                a prompt instructing agent to make 5years-old-like explanation
                with usage of analogies
              </kidAgent>
              <adultAgent>
                a prompt instructing agent to make an article appropriate for
                blogging audience
              </adultAgent>
              <professorAgent>
                a prompt instructing agent to make a deeply technical
                explanation for academics with usage of relevant formulas and
                code snippets
              </professorAgent>
            </variations>
          </taskResponse>
        ...
        <system>
          ...
          <responseFormat>
            ...
            <markdownFormattedFinalAnswer>
              A complete answer to user query accordingly to your instructions
