    ...
    async respond(fields) {
      ...
      const result = await executePrompt(
        <>
          ...
          <system>
            <instruction>
              Think about response to the question in described situation, then make a twitter post from the first
              person and return the result in following exact response format, avoid using hashtags, yet make it
